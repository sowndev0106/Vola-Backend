...
class ReadMessageInRoomHandler extends Handler_1.default {
    validate(request) {
    ...
    handle(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield RoomRepository_1.default.readMessageInRoom(input.roomId, input.myId);
            return result;
        });
    }
}
exports.default = new ReadMessageInRoomHandler();
